...
void setup() {
  ...
  String[] stuff22 = loadStrings("acceleration2.txt");
  acceleration2 = float(split(stuff22[0], ','));
  String[] stuff23 = loadStrings("acceleration3.txt");
  acceleration3 = float(split(stuff23[0], ','));
  String[] stuff24 = loadStrings("acceleration4.txt");
  acceleration4 = float(split(stuff24[0], ','));
  String[] stuff25 = loadStrings("acceleration5.txt");
  acceleration5 = float(split(stuff25[0], ','));
  String[] stuff26 = loadStrings("acceleration6.txt");
  acceleration6 = float(split(stuff26[0], ','));
  String[] stuff27 = loadStrings("acceleration7.txt");
